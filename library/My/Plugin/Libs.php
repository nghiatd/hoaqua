...
class My_Plugin_Libs extends Zend_Controller_Plugin_Abstract {
	...
	public static function randomInt($min = 1,$max=10, $except = false) {
		$n = rand($min, $max);
		while($n==$except)
			$n =self::randomInt($min,$max,$except);
		return $n;
	}
	...
	public static function toVietnameseDate($date, $format = "d/m/Y") {
		foreach ( array ('l', 'd', 'm', 'Y', 'H', 'i', 's' ) as $i )
			$vietnamese [$i] = date ( $i, $date );
			
		if (strpos ( $format, 'l' ) !== false) {
			$Day = array ('Chủ nhật', 'Thứ hai', 'Thứ ba', 'Thứ tư', 'Thứ năm', 'Thứ sáu', 'Thứ bảy' );
			$vietnamese ['l'] = $Day [date ( 'w', $date )];
		}
		if (strpos ( $format, 'm' ) !== false) {
			$Month = array ('01' => 'Tháng 1', '02' => 'Tháng 2', '03' => 'Tháng 3', '04' => 'Tháng 4', '05' => 'Tháng 5', '06' => 'Tháng 6', '07' => 'Tháng 7', '08' => 'Tháng 8', '09' => 'Tháng 9', '10' => 'Tháng 10', '11' => 'Tháng 11', '12' => 'Tháng 12' );
			$vietnamese ['m'] = $Month [date ( 'm', $date )];
			
		}
		
		$vietnamese = strtr ( $format, $vietnamese );
		//$Month = array ('01' => 'Tháng 1', '02' => 'Tháng 2', '03' => 'Tháng 3', '04' => 'Tháng 4', '05' => 'Tháng 5', '06' => 'Tháng 6', '07' => 'Tháng 7', '08' => 'Tháng 8', '09' => 'Tháng 9', '10' => 'Tháng 10', '11' => 'Tháng 11', '12' => 'Tháng 12' );
