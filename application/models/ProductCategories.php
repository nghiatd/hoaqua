...
class ProductCategories extends BaseProductCategories
{
	public static function getById($id = 0) {
		return Doctrine_Query::create ()->from ( __CLASS__ )->where ( 'id=?' )->execute ( array ($id ) )->getFirst ();
	}
	public static function getByNamePlain($id = 0) {
		return Doctrine_Query::create ()->from ( __CLASS__ )->where ( 'title_plain=?' )->execute ( array ($id ) )->getFirst ();
	}
	...
	public function getLink() {
		return 'san-pham/'.$this->title_plain . '.html';
	}
