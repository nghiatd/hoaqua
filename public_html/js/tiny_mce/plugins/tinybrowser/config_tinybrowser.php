...
$tinybrowser ['link'] ['image'] = '/uploads/'.$tinybrowser ['path'] ['image']; // Other file links
$tinybrowser ['link'] ['adv'] = $tinybrowser ['path'] ['adv']; // Other file links
...
$tinybrowser ['filetype'] ['adv'] = '*.swf,*.jpg, *.jpeg, *.gif, *.png'; // Image file types
